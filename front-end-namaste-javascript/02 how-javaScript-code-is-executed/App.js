...
/*
Notes :
- It's a mechanism where variables and function declaration are moved on top of the scope before 
  the code executed.
- whenever js code run it creates a global execution context and it has two components memory and code and it is 
...
- in phase two code execution phase Js program is execute line by line in variable it will replace undefined 
  with value of variable and similarly it will invokes the function. and when it invoke the function execution
  context is create. 
